    ...
    <div className="min-h-screen bg-background flex flex-col justify-center items-center p-4 md:p-8">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl shadow-primary/5 p-8 border border-gray-100">
        ...
        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
          ...
          <button className="w-full bg-primary text-white font-bold py-3.5 rounded-2xl shadow-md shadow-primary/20 hover:bg-primary/90 transition-all flex justify-center items-center gap-2 mt-4">
            Sign In
            <ArrowRight size={18} />
          </button>
        </form>
